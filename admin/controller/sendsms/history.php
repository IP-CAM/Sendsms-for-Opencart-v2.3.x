...
class ControllerSendsmsHistory extends Controller {
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('sendsms/history', 'token=' . $this->session->data['token'], true)
        );
        ...
        $data['sort_status'] = $this->url->link('sendsms/history', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
        $data['sort_message'] = $this->url->link('sendsms/history', 'token=' . $this->session->data['token'] . '&sort=message' . $url, true);
        $data['sort_details'] = $this->url->link('sendsms/history', 'token=' . $this->session->data['token'] . '&sort=details' . $url, true);
        $data['sort_content'] = $this->url->link('sendsms/history', 'token=' . $this->session->data['token'] . '&sort=content' . $url, true);
        $data['sort_type'] = $this->url->link('sendsms/history', 'token=' . $this->session->data['token'] . '&sort=type' . $url, true);
        $data['sort_sent_on'] = $this->url->link('sendsms/history', 'token=' . $this->session->data['token'] . '&sort=sent_on' . $url, true);
        $data['sort_phone'] = $this->url->link('sendsms/history', 'token=' . $this->session->data['token'] . '&sort=phone' . $url, true);
        ...
        $pagination->url = $this->url->link('sendsms/history', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
