...
class ControllerSendsmsCampaign extends Controller {
    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('sendsms/campaign/filter', 'token=' . $this->session->data['token']. $url, true));
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('sendsms/campaign', 'token=' . $this->session->data['token'], true)
        );
        ...
        $data['action'] = $this->url->link('sendsms/campaign', 'token=' . $this->session->data['token'], true);
        ...
        if(isset($this->request->post['filter_date_start'])) {
            $data['filter_date_start'] = $this->request->post['filter_date_start'];
        }

        $data['filter_date_end'] = '';
        if(isset($this->request->post['filter_date_end'])) {
            $data['filter_date_end'] = $this->request->post['filter_date_end'];
        }
    ...
    public function filter()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate_filtered()) {
            ...
            $this->response->redirect($this->url->link('sendsms/campaign', 'token=' . $this->session->data['token'], true));
        }
        ...
        $data['button_cancel'] = $this->language->get('button_cancel');
        $data['action'] = $this->url->link('sendsms/campaign/filter', 'token=' . $this->session->data['token'] . $url, true);
        $data['cancel'] = $this->url->link('sendsms/campaign', 'token=' . $this->session->data['token'], true);
