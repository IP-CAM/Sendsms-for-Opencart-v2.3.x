...
class ControllerExtensionModuleSendsms extends Controller {
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->link('extension/module/sendsms', 'token=' . $this->session->data['token'], true);
    ...
    public function install()
    {
        ...
        $this->model_extension_event->addEvent('sendsms', 'catalog/model/checkout/order/addOrderHistory/before', 'extension/module/sendsms/status_change');
